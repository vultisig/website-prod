...
export default function PrivacyPolicy() {
  return (
    <main className="terms-content" style={{ maxWidth: 1080, margin: "4vw auto 0 auto", padding: "2rem" }}>
      ...
      <ol type="1">
        ...
        <li><strong><u>HOW AND WHAT TYPES OF PERSONAL DATA DO WE COLLECT AND PROCESS</u></strong><br /> <br />
        ...
        <ul>
          <li>Details about your device, browser, or operating system; time zone setting;</li>
          <li>Your IP address, anonymized to protect your privacy;</li>
          <li>Information about interactions you have with the Website (such as scrolling and clicks);</li>
          <li>Referral Source: How you arrived at our website (e.g., via a search engine or direct link).</li>
          <li>Demographic Information: Such as age, gender, and interests (this is anonymized and based on Google’s demographic reports)</li>
        </ul>
        ...
        <li><strong><u>FOR WHAT PURPOSES DO WE USE YOUR PERSONAL DATA</u></strong><br /> <br />
        ...
        <ul>
          ...
          <li>Marketing, improvement and maintenance of Services as well as services and product development</li>
          <li>Security and prevention</li>
          <li>Compliance with statutory and regulatory requirements</li>
          <li>Protection of rights</li>
        </ul>
        </li> <br />
        <li><strong><u>LEGAL BASIS FOR PROCESSING AND DISCLOSURE OF YOUR PERSONAL DATA</u></strong><br /> <br />
        <ul>
          <li><strong>Lawful basis for processing your personal data:</strong> We will only use your personal data when the law allows us to. Most commonly we will use your personal data in the following circumstances:
            <ul>
              <li>Where you have asked us to do so, or consented to us doing so;</li>
              <li>Where it is necessary for the performance of a Service or in order to take steps at your request prior to providing the Services;</li>
            ...
            You will receive marketing messages from us by email if you have given us your consent to do so. To unsubscribe from marketing emails at any time and without cost, please click on the unsubscribe link at the bottom of any marketing email. You may also contact us (info@vultisig.com) to inform us if you do not wish to receive any marketing materials from us.
          </li>
          <li><strong>Sharing your personal information:</strong> If we collect personal data in the future, we may share it in the following ways:
            <ul>
        ...
        <li><strong><u>Your Rights</u></strong><br /> <br />
        <ul>
          <li><strong>Your Right to Access:</strong> You have the right to request access to your personal data that we hold about you, and to receive information about how we process it.</li>
          <li><strong>Your Right to Rectification:</strong> You have the right to request correction of any inaccurate or incomplete personal data we hold about you.</li>
          <li><strong>Your Right to Erasure:</strong> You have the right to request that we delete your personal data in certain circumstances.</li>
          <li><strong>Your Right to Restrict Processing:</strong> You have the right to request that we restrict the processing of your personal data in certain circumstances.</li>
          <li><strong>Your Right to Portability:</strong> You have the right to request that we provide your personal data to you in a structured, commonly used and machine-readable format, or to transmit it to another controller.</li>
          <li><strong>Your Right to Object:</strong> You have the right to object to our processing of your personal data in certain circumstances.</li>
          <li><strong>Your Right to Withdraw Consent:</strong> Where we rely on your consent to process your personal data, you have the right to withdraw that consent at any time.</li>
        </ul>
        </li> <br />
        <li><strong><u>ONLINE TRACKING AND INCLUDING USE OF COOKIES</u></strong><br /> <br />
        ...
        We use these technologies on our Webite and may allow certain third parties to do so as well. However, depending on the purpose of these technologies, we may ask for consent before they are used. You can access and change your current settings here. You can also set your browser to block or deceive certain types of cookies or alternative technologies, or to delete existing cookies. You can also add software to your browser that blocks certain third-party tracking. You can find more information on the help pages of your browser (usually with the keyword «Privacy») or on the websites of the third parties set out below.
        Currently we only use the following cookies:
        <ul>
          <li><strong>Analytical Cookies:</strong> Analytical cookies are used to understand how visitors interact with the website. These cookies help provide information on metrics such as the number of visitors, bounce rate, traffic source, etc.</li>
        </ul>
