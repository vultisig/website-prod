    ...
    <main className="min-h-screen pt-24 xs:pt-32 pb-20 px-2 xs:px-3 sm:px-4 bg-[var(--background)]">
      ...
      <section className="container mb-24 xs:mb-16 sm:mb-20">
        <h2 className="text-2xl xs:text-3xl sm:text-4xl md:text-5xl font-bold text-white text-center mb-4 xs:mb-5 sm:mb-6 max-w-2xl mx-auto">
          ...
          <br />
          <GradientText className="inline-block text-2xl xs:text-3xl sm:text-4xl md:text-5xl mt-2">
            $5M Vultisig Airdrop
          </GradientText>
        </h2>
        <div className="w-full flex justify-center items-center">
            ...
            <div className="airdrop-carousel flex overflow-x-auto snap-x snap-mandatory gap-4 w-full px-1 -mx-1 carousel-scrollbar">
              ...
              <Card className="min-w-[320px] max-h-[50vw] snap-center bg-[var(--background-secondary)] border border-[var(--border-light)] rounded-2xl px-4 py-4 flex flex-col items-start shadow-lg">
                <div className="flex items-center w-full mb-2">
                  <span className="text-white font-extrabold text-lg xs:text-xl md:text-2xl flex-1">
                    Download app
                  </span>
                  <span className="ml-2 flex items-center justify-center w-8 xs:w-9 h-8 xs:h-9 rounded-full bg-cyan-900 text-cyan-400 font-bold text-base xs:text-lg">
                    01
                  </span>
                </div>
                <span className="text-gray-300 text-xs xs:text-sm mt-2">
                  Start by downloading the Vultisig app from the app store.
                  Create an account to get access to the platform and airdrop.
                </span>
              </Card>
              {/* Card 2 */}
              <Card className="min-w-[320px] max-h-[50vw] snap-center bg-[var(--background-secondary)] border border-[var(--border-light)] rounded-2xl px-4 py-4 flex flex-col items-start shadow-lg">
                ...
                <span className="text-gray-300 text-xs xs:text-sm mt-2">
                  Create a Vultisig Vault with multi-factor authentication to
                  protect your assets and enhance your account security.
                </span>
              </Card>
              {/* Card 3 */}
              <Card className="min-w-[320px] max-h-[50vw] snap-center bg-[var(--background-secondary)] border border-[var(--border-light)] rounded-2xl px-4 py-4 flex flex-col items-start shadow-lg">
                ...
                <span className="text-gray-300 text-xs xs:text-sm mt-2">
                  Each device in a vault has its own backup share. Back it up.
                </span>
              </Card>
              {/* Card 4 */}
              <Card className="min-w-[320px] max-h-[50vw] snap-center bg-[var(--background-secondary)] border border-[var(--border-light)] rounded-2xl px-4 py-4 flex flex-col items-start shadow-lg">
                ...
                <span className="text-gray-300 text-xs xs:text-sm mt-2">
                  Deposit funds into Vultisig vaults to qualify for the airdrop
                  and participate in platform activities.
                </span>
              </Card>
              {/* Card 5 */}
              <Card className="min-w-[320px] max-h-[50vw] snap-center bg-[var(--background-secondary)] border border-[var(--border-light)] rounded-2xl px-4 py-4 flex flex-col items-start shadow-lg">
                ...
                <span className="text-gray-300 text-xs xs:text-sm mt-2">
                  Join the airdrop and follow the leaderboard on
                  airdrop.vultisig.com.
                </span>
              </Card>
            </div>
          </div>
          ...
          <div className="hidden md:grid grid-cols-1 md:grid-cols-3 grid-rows-5 md:grid-rows-2 gap-4 xs:gap-5 sm:gap-6 w-full max-w-full xs:max-w-2xl sm:max-w-4xl md:max-w-[1400px] relative">
            ...
            <div className="row-start-4 md:row-start-3 col-start-1 md:col-start-2 flex justify-center items-center">
              <Card
                className="w-full xs:w-64 sm:w-80 min-w-[320px] bg-[var(--background-secondary)]
      ...
      <section className="max-w-4xl mx-auto mt-16 xs:mt-20 sm:mt-24 mb-8 xs:mb-10 sm:mb-12 px-0 xs:px-2">
        <h2 className="text-2xl xs:text-3xl sm:text-4xl md:text-5xl font-bold text-white text-center mb-8 xs:mb-10 sm:mb-12">
          Frequently asked{" "}
          <GradientText className="inline-block">questions</GradientText>
        </h2>
        <div className="w-full flex justify-center items-center">
          <div className="w-full">
            <Accordion
            ...
            >
              ...
              >
                ...
                <AccordionContent className="text-gray-300 px-4 xs:px-6 pb-4 xs:pb-6 pt-0 font-normal text-sm xs:text-base">
                  ...
                  <span className="text-gray-400">
                    ...
                    multiplied by the time the assets are held in the vault. The
                    largest amounts for the longest time earn the most. Read
                    more about it here.
                  </span>
                </AccordionContent>
              </AccordionItem>
              ...
              >
                ...
                <AccordionContent className="text-gray-300 px-4 xs:px-6 pb-4 xs:pb-6 pt-0 font-normal text-sm xs:text-base">
                  Layer 1 assets and most tokens supported by Vultisig are
                  counted. Other active assets such as LPs and Node Bonds from
                  THORChain, MAYA Protocol and staked token are also valid.
                  <br />
              ...
              >
                ...
                <AccordionContent className="text-gray-300 px-4 xs:px-6 pb-4 xs:pb-6 pt-0 font-normal text-sm xs:text-base">
                  Your assets will accumulate VULTIES over a period of 12
                  months. At the end of this period, you will receive your share
                  of the airdrop (5% of $VULT).
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </div>
