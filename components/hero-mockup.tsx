  ...
  return (
    <div className="relative w-full max-w-[658px] mx-auto" style={{ aspectRatio: "658/654" }}>
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <Image src="/images/hero/glow-2.svg" alt="" width={222} height={320} loading="lazy" className="absolute" style={{ top: "10%", left: "20%", width: "34%" }} />
        <Image src="/images/hero/glow-3.svg" alt="" width={222} height={320} loading="lazy" className="absolute mix-blend-plus-lighter" style={{ top: "10%", left: "30%", width: "34%" }} />
        <Image src="/images/hero/glow-5.svg" alt="" width={314} height={423} loading="lazy" className="absolute" style={{ top: "40%", left: "55%", width: "48%" }} />
        <Image src="/images/hero/glow-6.svg" alt="" width={314} height={346} loading="lazy" className="absolute mix-blend-plus-lighter" style={{ top: "38%", left: "48%", width: "48%" }} />
      </div>
        ...
        <div className="relative">
          ...
          <div className="absolute overflow-hidden rounded-[8%]" style={{ top: "5.5%", left: "9.4%", width: "37.5%", height: "89%" }}>
            <Image
              ...
              width={491}
              height={1059}
              sizes="(max-width: 768px) 30vw, 115px"
      ...
      <div className="absolute z-20" style={{ left: "12.3%", top: "30.4%", width: "29.8%" }}>
        <div className="bg-backgroundSecondary rounded-[21px] p-[7px] shadow-[0px_8px_16px_rgba(0,0,0,0.25),0px_-2px_7px_rgba(3,13,29,0.35)] relative">
          <div className="flex flex-col gap-[5px]">
            <div className="bg-backgroundSecondary border border-borderLight rounded-t-[15px] rounded-b-[7px] p-[10px] flex items-center justify-between">
            ...
            <div className="bg-cardSurface/50 border border-borderLight rounded-t-[7px] rounded-b-[15px] p-[10px] flex items-center justify-between">
              <div className="bg-borderLight rounded-full pl-[4px] pr-[7px] py-[4px] flex items-center gap-[5px]">
            ...
            <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-10">
              <div className="bg-cardSurface/50 border border-borderLight rounded-full p-[4px]">
      ...
      <div className="absolute z-20 bg-backgroundSecondary rounded-full px-[10px] py-[7px] flex items-center gap-[7px] shadow-[0px_7px_13px_rgba(0,0,0,0.25),0px_-2px_6px_rgba(3,13,29,0.35)]" style={{ left: "32.7%", top: "18.2%" }}>
      ...
      <div className="absolute z-20 bg-backgroundSecondary rounded-full px-[10px] py-[7px] flex items-center gap-[7px] shadow-[0px_7px_13px_rgba(0,0,0,0.25),0px_-2px_6px_rgba(3,13,29,0.35)]" style={{ left: "70.2%", top: "29.7%" }}>
      ...
      <div className="absolute z-20" style={{ left: "67.8%", top: "53.7%", width: "29.3%" }}>
        <div className="bg-gradient-to-b from-[#4879fd] to-[#0d39b1] rounded-[21px] p-[10px] flex flex-col gap-[7px] shadow-[0px_8px_16px_rgba(0,0,0,0.25),0px_-2px_7px_rgba(3,13,29,0.35)] relative">
          <div className="bg-backgroundSecondary border border-borderLight rounded-[15px] flex items-center gap-[7px] p-[10px]">
      ...
      <div className="absolute z-20" style={{ left: "20.2%", top: "62.5%", width: "19%" }}>
        <div className="bg-gradient-to-b from-[#4879fd] to-[#0d39b1] rounded-[21px] p-[4px] pb-[9px] flex flex-col items-center gap-[4px] shadow-[0px_7px_14px_rgba(0,0,0,0.25),0px_-2px_6px_rgba(3,13,29,0.35)] relative">
          <div className="bg-backgroundSecondary border border-borderNormal rounded-[18px] p-[4px] relative overflow-hidden">
