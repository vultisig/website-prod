...
export default function CtaSection() {
  return (
    <section className="py-20 container relative border border-borderLight rounded-2xl overflow-hidden md:aspect-[2.7/1] intersect-once intersect:motion-preset-slide-up-md">
      <Image
        src={bannerPng}
