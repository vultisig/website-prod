...
export default function OpenSourceCard() {
  ...
  return (
    <div ref={containerRef} className="border border-borderLight rounded-3xl overflow-hidden flex flex-col items-start justify-end min-h-[260px] lg:h-[277px] relative">
      <Lottie
        lottieRef={lottieRef}
